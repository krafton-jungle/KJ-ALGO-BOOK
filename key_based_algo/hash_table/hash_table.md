## 📑 목차
<<<<<<< HEAD
- [해시 테이블(Hadh Table)](#해시-테이블hash-table)
- [해시(Hash)란?](#해시hash란)
- [해시 테이블의 정의](#해시-테이블의-정의)
- [해시 테이블의 구조](#해시-테이블의-구조)
  - [해시 함수(Hash Function)](#1-해시-함수hash-function)
  - [버킷(Bucket)](#2-버킷bucket)
  - [충돌 해결(Collision Resolution)](#3-충돌-해결collision-resolution)
- [해시 테이블은 어디에 사용되고, 왜 필요한가?](#해시-테이블은-어디에-사용되고-왜-필요한가)
- [해시 테이블을 사용한 알고리즘](#해시-테이블을-사용한-알고리즘)
  - [중복 검사 or 유일한 값 찾기](#1-중복-검사-or-유일한-값-찾기)
  - [빈도 카운팅](#2-빈도-카운팅)
  - [Two Sum 문제](#3-two-sum-문제)
=======
